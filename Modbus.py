...
class MainWindow(QMainWindow, mainwindow.Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.Send.clicked.connect(self.fn_sendcmd)              # клик на кнопку ОТПРАВИТЬ
        ...
        self.setGeometry(0, 0, 809, 409)                        # расположение главновго окна
        ...
        self.Exit.setIcon(icon_switch_off)
        self.Exit.setIconSize(QtCore.QSize(57, 57))

    def fn_sendcmd(self):                                       # извлекаем содержимое ячеек
        self.ed_id=self.LE_1.text()                             # адрес устройства ID
        #print(self.ed_id)
        self.ed_cmd=self.LE_2.text()                            # номер команды
        #print(self.ed_cmd)
        self.ed_adr=self.LE_3.text()                            # адрес регистра
        #print(self.ed_adr)
        self.ed_count=self.LE_4.text()                          # данные
